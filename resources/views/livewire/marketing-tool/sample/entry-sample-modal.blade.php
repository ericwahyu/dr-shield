<div class="modal fade modal-md" id="modal-entry" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" wire:ignore.self>
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5">Stock Masuk</h1>
            ...
            <div class="modal-body">
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <div class="form-label">Jumlah Stock Masuk <span class="text-danger">*</span></div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success btn-sm" wire:click="saveDataEntrySample()">Simpan <i class="fa-solid fa-circle-check fa-fw ms-2"></i></button>
            </div>
        </div>
    </div>
</div>
