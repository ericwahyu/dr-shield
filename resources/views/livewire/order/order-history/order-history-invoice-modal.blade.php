<div class="modal fade modal-md" id="modal-payment" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" wire:ignore.self>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-3">
                ...
                <div class="d-flex">
                    ...
                    <div class="ms-auto">
                        @if ($get_product?->is_roof == 1)
                            <span class="badge rounded-pill bg-dark bg-glow mb-0">Genteng</span>
                        @else
                            <span class="badge rounded-pill bg-warning bg-glow mb-0">UPVC</span>
                        @endif
                    </div>
                </div>
