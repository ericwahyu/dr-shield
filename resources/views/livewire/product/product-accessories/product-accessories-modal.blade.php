    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5">Form Data Aksesoris</h1>
            ...
            <div class="modal-body">
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <select class="form-select @error('category') is-invalid @enderror" id="category" wire:model="category" aria-label="Default select example" disabled>
                    ...
                    <div class="col-6">
                        <div class="form-label">Perhitungan <span class="text-danger">*</span></div>
                        {{-- <input type="text" class="form-control @error('category') is-invalid @enderror" wire:model="category" placeholder=""> --}}
                        <select class="form-select @error('calculated') is-invalid @enderror" id="calculated" wire:model.live="calculated" aria-label="Default select example">
                            <option value="" selected style="display: none">-- Pilih Perhitungan --</option>
                            <option value="accessories" {{ $calculated == 'accessories' ? "selected" : "" }}>Lebar Efektif</option>
                            <option value="pieces" {{ $calculated == 'pieces' ? "selected" : "" }}>Jumlah Barang</option>
                        </select>
                        @error('calculated')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-6">
                        <div class="form-label">Satuan Harga <span class="text-danger">*</span></div>
                        {{-- <input type="text" class="form-control @error('category') is-invalid @enderror" wire:model="category" placeholder=""> --}}
                        <select class="form-select @error('price_unit') is-invalid @enderror" id="price_unit" wire:model.live="price_unit" aria-label="Default select example">
                            <option value="" selected style="display: none">-- Pilih Perhitungan --</option>
                            <option value="Lembar" {{ $price_unit == 'Lembar' ? "selected" : "" }}>Lembar</option>
                            <option value="40 pcs" {{ $price_unit == '40 pcs' ? "selected" : "" }}>Pack (40 Pcs)</option>
                        </select>
                        @error('price_unit')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
